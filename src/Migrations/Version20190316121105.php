 ...
 */
final class Version20190316121105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE user_status user_status enum(\'Active\',\'Inactive\'), CHANGE group_id category INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE user_status user_status VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE category group_id INT NOT NULL');
